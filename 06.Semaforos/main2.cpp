...
#include "./Semaforo/MemoriaCompartida.h"
...
int main () {
	...
	static const string NOMBRE1 = "main1.cpp";
	static const string NOMBRE2 = "main2.cpp";
	static const string NOMBRE3 = "main3.cpp";
	static const string SHM = "Semaforo/Semaforo.cpp";
